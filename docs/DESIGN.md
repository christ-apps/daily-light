...
- 按周视图查看时，横坐标代表群排行生效日以来的周数，纵坐标代表每周打卡的总章数
- 按总视图查看时，横坐标代表群排行生效日以来的周数，纵坐标代表从群排行生效日开始到该周为止累计打卡的总章数
- 进入别人的个人主页时，显示的是来源群的统计数据

### 查看卷进度

在个人主页中显示每卷书的打卡进度和已读整卷次数。

- 进度条显示用户阅读该卷书的章数覆盖率，**计算公式为：群排行生效日以来用户阅读该卷书的非重复章数 ÷ 该卷书包含的总章数**
- 已读整卷次数代表用户完整阅读该卷书的次数，**计算公式为：群排行生效日以来用户阅读该卷书中各章的次数的最小值**
- 进入别人的个人主页时，显示的是来源群的统计数据
